...
public class StationListActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new StationsListAdapter(stations, this);
        ...
        call.enqueue(new Callback<StationList>() {
            ...
            public void onResponse(Call<StationList> call, Response<StationList> response) {
                ...
                if (stationList != null) {
                    stations.addAll(stationList.getData());
                    adapter.notifyDataSetChanged();
                } else {
                    Toast.makeText(StationListActivity.this, "Błąd pobranych danych!",
    ...
    public void onStationClick(int position) {
        ...
        int stationNumber = stations.get(position).getNo();
